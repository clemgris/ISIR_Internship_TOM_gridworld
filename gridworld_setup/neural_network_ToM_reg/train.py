...
if __name__ == '__main__':
    ...
    for epoch in range(n_epochs):
        ...
        if eval_val_dict['metric'] > best_model_acc:
            best_model_acc = eval_val_dict['metric']

            torch.save(regnet.state_dict(), saving_path_acc) # save model
    ...
    # Save outputs (NLL loss and metric)
    dict_outputs = dict(train=training_outputs,
                        val=validation_outputs,
                        test=test_outputs)
