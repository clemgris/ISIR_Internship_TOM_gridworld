...
def preprocess_data(
    data_path: str, max_length_obs: int, max_length_demo_eval: int
) -> tuple:
...
class ToMNetDataset(Dataset):
    def __init__(self, data_paths, max_length_obs, max_length_demo_eval) -> None:
    ...
    def __getitem__(self, ind):
        ...
        [obs, demo_eval], nex_action, query_state = preprocess_data(
            data_path, self.max_length_obs, self.max_length_demo_eval
        )
